...
import com.lucasfreitaas.payment_system.pix.Credentials;
...
public class PixService {
    ...
    public JSONObject pixCreateEVP() {
        ...
        String certPath = new java.io.File(credentials.getCertificate()).getAbsolutePath();
        ...
        try {
            ...
            System.out.println("Erro EFI: " + e.getErrorDescription());
        } catch (Exception e) {
    ...
    public JSONObject pixcreateCharge(PixChargeRequest pixChargeRequest){
        ...
        infoAdicionais.put(new JSONObject().put("nome", "Campo 2").put("valor", "Informação Adicional1 do PSP-Recebedor"));
